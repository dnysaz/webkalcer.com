        ...
        <div className="rounded-lg border-2 border-zinc-200 bg-white p-6">
          ...
          <div className="mt-4 space-y-4">
            <div>
              ...
              <input name="badge_text" defaultValue={hero?.badge_text ?? ""} className="w-full rounded-md border-2 border-zinc-200 px-4 py-3 text-sm font-bold outline-none transition focus:border-pink" />
            </div>
            <div>
              <label className="mb-1 block text-sm font-bold text-zinc-600">Headline</label>
              <textarea name="headline" rows={4} defaultValue={hero?.headline ?? ""} className="w-full rounded-md border-2 border-zinc-200 px-4 py-3 text-sm font-bold outline-none transition focus:border-pink" />
              <p className="mt-1 text-xs text-zinc-500">Use \n for new line</p>
            </div>
            <div>
              <label className="mb-1 block text-sm font-bold text-zinc-600">Subheadline</label>
              <input name="subheadline_text" defaultValue={hero?.subheadline_text ?? ""} className="w-full rounded-md border-2 border-zinc-200 px-4 py-3 text-sm font-bold outline-none transition focus:border-pink" />
            </div>
            <div>
              <label className="mb-1 block text-sm font-bold text-zinc-600">CTA Text</label>
              <input name="cta_text" defaultValue={hero?.cta_text ?? ""} className="w-full rounded-md border-2 border-zinc-200 px-4 py-3 text-sm font-bold outline-none transition focus:border-pink" />
            </div>
          </div>
        </div>
