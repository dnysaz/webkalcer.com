...
export default function NewTestimonialPage() {
  return (
    <div className="mx-auto max-w-4xl">
      <h1 className="text-2xl font-black tracking-tighter text-dark">Add Testimonial</h1>
      <p className="mt-1 mb-10 text-sm font-bold text-zinc-500">Fill in new customer testimonial data.</p>
        ...
        <div className="rounded-lg border-2 border-zinc-200 bg-white p-6">
          ...
          <div className="mt-4 space-y-4">
            <div>
              ...
              <input name="name" required className="w-full rounded-md border-2 border-zinc-200 px-4 py-3 text-sm font-bold outline-none transition focus:border-pink" />
            </div>
            <div>
              <label className="mb-1 block text-sm font-bold text-zinc-600">Role / Job</label>
              <input name="role" required className="w-full rounded-md border-2 border-zinc-200 px-4 py-3 text-sm font-bold outline-none transition focus:border-pink" />
            </div>
            <div>
              <label className="mb-1 block text-sm font-bold text-zinc-600">Quote</label>
              <textarea name="quote" required rows={3} className="w-full rounded-md border-2 border-zinc-200 px-4 py-3 text-sm font-bold outline-none transition focus:border-pink" />
            </div>
