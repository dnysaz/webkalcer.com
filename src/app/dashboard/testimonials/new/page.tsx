...
export default function NewTestimonialPage() {
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <p className="mt-1 mb-10 text-sm font-bold text-zinc-400">Fill in new customer testimonial data.</p>
        ...
        <div className="rounded-2xl border-2 border-zinc-200 bg-white p-6">
          ...
          <div className="mt-4 space-y-4">
            ...
            <div>
              ...
              <input name="role" required className="w-full rounded-xl border-2 border-zinc-200 px-4 py-3 text-sm font-bold outline-none transition focus:border-pink" />
            </div>
            <div>
              <label className="mb-1 block text-sm font-bold text-zinc-600">Quote</label>
              <textarea name="quote" required rows={3} className="w-full rounded-xl border-2 border-zinc-200 px-4 py-3 text-sm font-bold outline-none transition focus:border-pink" />
            </div>
