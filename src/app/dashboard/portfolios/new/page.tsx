...
export default function NewPortfolioPage() {
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <p className="mt-1 mb-10 text-sm font-bold text-zinc-400">Add a finished website example.</p>
        ...
        <div className="rounded-2xl border-2 border-zinc-200 bg-white p-6">
          ...
          <div className="mt-4 space-y-4">
            <div>
              ...
              <input name="title" required className="w-full rounded-xl border-2 border-zinc-200 px-4 py-3 text-sm font-bold outline-none transition focus:border-pink" />
            </div>
            <div>
              <label className="mb-1 block text-sm font-bold text-zinc-600">Tag (e.g. UMKM, Personal Branding)</label>
              <input name="tag" required className="w-full rounded-xl border-2 border-zinc-200 px-4 py-3 text-sm font-bold outline-none transition focus:border-pink" />
            </div>
            <div>
              <label className="mb-1 block text-sm font-bold text-zinc-600">Website Link</label>
              <input name="url" type="url" placeholder="https://contoh.com" className="w-full rounded-xl border-2 border-zinc-200 px-4 py-3 text-sm font-bold outline-none transition focus:border-pink" />
            </div>
