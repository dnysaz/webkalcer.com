...
const faqs = [
  ...
  { q: "BERAPA LAMA WEBSITENYA JADI KAKAK?", a: "Paket Website Profil selesai 1x24 jam kakak. Paket Admin Panel 3-5 hari. Web App 1-2 minggu tergantung kompleksitas." },
